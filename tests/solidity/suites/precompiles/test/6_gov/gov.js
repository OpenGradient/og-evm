...
describe('Gov Precompile', function () {
    ...
    const GOV_MODULE_ADDR = 'og10d07y265gmmuvt4z0w9aw880jnsr700j6zn9kn'
    ...
    it('deposits on the global proposal', async function () {
        ...
        const depRcpt = await waitWithTimeout(depTx, 60000, RETRY_DELAY_FUNC)
    ...
    it('votes on the global proposal', async function () {
        ...
        const voteRcpt = await waitWithTimeout(voteTx, 60000, RETRY_DELAY_FUNC)
    ...
    it('cancels a proposal', async function () {
        ...
        const cancelRcpt = await waitWithTimeout(cancelTx, 60000, RETRY_DELAY_FUNC)
