...
describe('Staking – delegate, undelegate & cancelUnbondingDelegation with event assertions', function () {
    ...
    it('should delegate, undelegate, then cancel unbonding and emit correct events', async function () {
        const valBech32 = 'ogvaloper10jmp6sgh4cc6zt3e8gw05wavvejgr5pwn5se8x'
        ...
        const undelegateReceipt = await waitWithTimeout(undelegateTx, 60000, RETRY_DELAY_FUNC)
        ...
        const cancelReceipt = await waitWithTimeout(cancelTx, 60000, RETRY_DELAY_FUNC)
