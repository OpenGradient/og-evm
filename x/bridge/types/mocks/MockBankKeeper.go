...
// BankKeeper is a mock type for the bridge BankKeeper interface.
...
func (_m *BankKeeper) MintCoins(ctx context.Context, moduleName string, amounts types.Coins) error {
