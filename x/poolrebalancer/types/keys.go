...
const (
	...
	// TransientStoreKey holds per-block scratch data (e.g. slash snapshots for EndBlock use).
...
var (
	...
	// When set, EndBlock should run CommunityPool total-staked reconcile (also triggered on periodic sweep).
